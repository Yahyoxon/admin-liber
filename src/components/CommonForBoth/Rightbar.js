          ...
          <SimpleBar style={{ height: "900px" }}>
            <div data-simplebar className="h-100">
              <div className="rightbar-title px-3 py-4">
                ...
                <h5 className="m-0">Созламалар</h5>
              </div>
              ...
              <div className="p-4">
                <div className="radio-toolbar">
                  <span className="mb-2 d-block">Жойлаштиришлар</span>
                  <Input
                    type="radio"
                    id="radioVertical"
                    name="radioFruit"
                  ...
                  <Label htmlFor="radioVertical">Вертикал</Label>
                  {"   "}
                  <Input
                    type="radio"
                    id="radioHorizontal"
                    ...
                    onChange={this.changeLayout} />
                  <Label htmlFor="radioHorizontal">Горизонталь</Label>
                </div>

                <hr className="mt-1" />

                <div className="radio-toolbar">
                  <span className="mb-2 d-block" id="radio-title">Юқори панель мавзуси</span>
                  <Input
                    type="radio"
                    id="radioThemeLight"
                    name="radioTheme"
                  ...
                  <Label htmlFor="radioThemeLight">Ёрқин</Label>
                  {"   "}
                  <Input
                    type="radio"
                    id="radioThemeDark"
                    ...
                    onChange={this.changeTopbarTheme} />
                  <Label htmlFor="radioThemeDark">Қоронғи</Label>
                  {"   "}
                ...
                {this.state.layoutType === "vertical" ? <React.Fragment>
                  <hr className="mt-1" />
                  <div className="radio-toolbar">
                    <span className="mb-2 d-block" id="radio-title">Чап ён панель тури</span>
                    <Input
                      type="radio"
                      id="sidebarDefault"
                      name="sidebarType"
                    ...
                    <Label htmlFor="sidebarDefault">Стандарт</Label>
                    {"   "}
                    <Input
                      type="radio"
                      id="sidebarCompact"
                      ...
                      onChange={this.changeLeftSidebarType} />
                    <Label htmlFor="sidebarCompact">Компакт</Label>
                    {"   "}
                    <Input
                      type="radio"
                      id="sidebarIcon"
                      ...
                      onChange={this.changeLeftSidebarType}
                    />
                    <Label htmlFor="sidebarIcon">Белги</Label>
                  ...
                  <div className="radio-toolbar">
                    <span className="mb-2 d-block" id="radio-title">Чап ён панель ранги</span>
                    <Input
                      type="radio"
                    ...
                    <Label htmlFor="leftsidebarThemelight">Ёрқин</Label>
                    {"   "}
                    <Input
                      type="radio"
                      ...
                      onChange={this.changeLeftSidebarTheme} />
                    <Label htmlFor="leftsidebarThemedark">Қоронғи</Label>
                    {"   "}
                    <Input
                      type="radio"
                      ...
                      onChange={this.changeLeftSidebarTheme}
                    />
                    <Label htmlFor="leftsidebarThemecolored">Рангли</Label>
                ...
                <FormGroup>
                  ...
                  <span className="mb-2 d-block" id="radio-title">Қайта юклаш</span>
                  ...
                  <div className="form-check form-switch mb-3">
                    ...
                    <Label className="form-check-label" htmlFor="checkbox_1">Қайта юклаш</Label>
                  </div>
