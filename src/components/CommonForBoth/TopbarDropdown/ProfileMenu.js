            ...
            <React.Fragment>
                <Dropdown isOpen={this.state.menu} toggle={this.toggle} className="d-inline-block user-dropdown">
                    ...
                    <DropdownMenu className="dropdown-menu-end">
                        ...
                        <DropdownItem href="#"><i className="ri-wallet-2-line align-middle me-1"></i> {('My Wallet')}</DropdownItem>
                        <DropdownItem className="d-block" href="#"><span className="badge badge-success float-end mt-1">11</span><i className="ri-settings-2-line align-middle me-1"></i> {('Settings')}</DropdownItem>
                        <DropdownItem href="#"><i className="ri-lock-unlock-line align-middle me-1"></i> {('Lock screen')}</DropdownItem>
