...
let users = [
  { id: 1, username: 'admin', password: '123456', email: 'admin@liber.com' }
];
    ...
    return new Promise(function (resolve, reject) {
      setTimeout(function () {
        if (validUser['length'] === 1) {
          ...
          reject([400, "Фойдаланувчи номи ва пароль яроқсиз. Илтимос, тўғри фойдаланувчи номи ва паролни киритинг"]);
        }
      });
    });
  });
